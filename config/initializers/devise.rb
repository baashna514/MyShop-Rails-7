...
Devise.setup do |config|
  ...
  config.mailer_sender = 'moinabbas80@gmail.com'
  # The secret key used by Devise. Devise uses this key to generate
  # random tokens. Changing this key will render invalid all existing
  # confirmation, reset password and unlock tokens in the database.
  # Devise will use the `secret_key_base` as its `secret_key`
  # by default. You can change it below and use your own secret key.
  # config.secret_key = 'f36f46a75af781638b9c07ccd39f90e6097d04ae7e0fc33048c71c02e9ecd349c50d3346aee15176432a44af781da9f174b71b1a1e900af3541878ad5491df9f'
  ...
  # config.pepper = '15c6c4c0ba48280e0bc3a1993cd96b9e62d21447b9f634e465f77bae1ac4ca1eef41fa8748bc8c7123a62a655ef0a19483dceb4b87fba0e93520f37bbf50e890'
